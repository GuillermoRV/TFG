...
#ax.plot(x,y,label='r\N{SUBSCRIPT ZERO}='+str(1/u[0]),color='blue');ax.legend(loc='upper left', bbox_to_anchor=(0.5, -0.05),fancybox=True, shadow=True, ncol=5)
plt.plot(x,y,'blue')
plt.xlabel('x');plt.ylabel('y')
plt.xlim(-30,75);plt.ylim(-30,75)
plt.title('M='+str(M)+';l='+str(l)+'(Geometrical Units)')
#plt.scatter(0,0)
plt.grid()
print(l**2>12*M**2)
